...
public class WebViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String host = sharedPreferences.getString("edittext_preference_host", "172.30.51.113");//read host from configurations
		Log.d("Host", host);
		String port = sharedPreferences.getString("edittext_preference_port", "9443");//read port from configurations
		Log.d("Port", port);
